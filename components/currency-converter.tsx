...
// Extend the Currency type to include BHD (Bahrain Dinar) and SAR (Saudi Riyal)
type Currency = "USD" | "EUR" | "GBP" | "JPY" | "AUD" | "CAD" | "PKR" | "BHD";
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectGroup>
                        ...
                        <SelectItem value="BHD">BHD </SelectItem> {/* Added Bahrain */}
                      </SelectGroup>
                    </SelectContent>
                  </Select>
                </div>
